...
export default function HomeLayout() {
  return (
    <Stack>
      ...
      <Stack.Screen name="tournaments/[tournament]/match/[match]" options={{ headerStyle: {backgroundColor: '#F8FAFC'}, headerShadowVisible: false, headerTintColor: "#211071", headerTitle: "", headerBackTitle: "Tournament" }} />
